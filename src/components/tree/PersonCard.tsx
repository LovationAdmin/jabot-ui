...
export function PersonCard({ person, selected, onSelect, isAuthenticated = false }: PersonCardProps) {
  ...
  return (
    ...
    >
      {/* Photo — masquee pour les visiteurs */}
      ...
      <div className="min-w-0 flex-1">
        ...
        {isAuthenticated && person.nicknames && person.nicknames.length > 0 && (
          <p className="truncate text-[11px] text-primary/80">&laquo; {person.nicknames[0]} &raquo;</p>
        )}
